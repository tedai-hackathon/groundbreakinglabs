...
async function getData(studentId: string) {
    const res = await fetch(`/api/generate/${studentId}`, { cache: 'no-store' });
        ...
        return (
            <div className="min-h-screen bg-emerald-600 p-10">
                ...
                <div className="p-8 rounded-md max-w-3xl mx-auto">
                    ...
                    <ReadingPrompt text={data['text'] ?? 'Loading...'} />

                    <div className="mb-4">
                        <PassageSetOfQuestions
                            questions={data['questions'] ?? []}
                        />
                    </div>

                    <Button
                        className="w-[125px] mt-5"
                        label={'Submit'}
                        link="review"
                    />
                </div>
        ...
        return (
            <div className="min-h-screen bg-emerald-600 p-10">
                ...
                <div className="p-8 rounded-md max-w-3xl mx-auto">
                    ...
                    <ReadingPrompt text={'Loading...'} />

                    <div className="mb-4">
                        <PassageSetOfQuestions questions={[]} />
                    </div>
